...
public class Ex117 extends HttpServlet
  {
       ...
       try
         {
           ...
           con = DriverManager.getConnection("jdbc:odbc:Bank117"); 
         }
       catch(Exception e){}
      }
   ...
   public synchronized void doGet(HttpServletRequest req,
           ...
           throws ServletException, IOException
     {
       ...
       String sql2 = "UPDATE Deposit " +
        ...
        out.println("<HTML><HEAD><TITLE>Ex117</TITLE></HEAD>");
        out.println("<BODY>");
        SqlTransaction result = new SqlTransaction(con, sql1, sql2, sql3);
        out.println(result);
