...
public class Ex122 extends HttpServlet
  {
       ...
       try
         {
           ...
           con = DriverManager.getConnection("jdbc:odbc:Bank122"); 
         }
       catch(Exception e){}
      }
   ...
   public synchronized void doGet(HttpServletRequest req,
           ...
           throws ServletException, IOException
     {
       ...
       String sql6 = "SELECT balance " +
        ...
        out.println("<HTML><HEAD><TITLE>Ex122</TITLE></HEAD>");
        out.println("<BODY>");
        SqlTransaction result = new SqlTransaction(con, sql1, sql2, sql3, sql4, sql5, sql6);
        out.println(result);
